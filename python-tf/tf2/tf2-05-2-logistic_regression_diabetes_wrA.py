...
tf.model.add(tf.keras.layers.Dense(units=100, input_dim=x_data.shape[1], activation='relu'))
# 3 deep
...
images.image.save_fig("tf2.5.2.lr_wrA_loss_accuracy_by_epochs_size")    
plt.show()
